...
type Props={selected:Record<number,string>;onSelect:(channel:number,key:string)=>void;mix:number;mixName:string;mixId:string;state:ProgramState;inputs:Source[];locked:boolean;online:boolean;transition:string;stingers:number;onStinger:(effect:string)=>void;onControl:(control:ProgramControl)=>void};
